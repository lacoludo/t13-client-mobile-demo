...
> {
  ...
  render(): React.Node {
    ...
    return (
      <View style={styles.container}>
        <Text type="header3" gutterBottom style={styles.text}>
          Take Pictures with T13
        </Text>
        <Text gutterBottom style={styles.text}>
          Allow access to your camera roll to start taking photos with T13.
        </Text>
        {canOpen === true && (
          <Button
            label="Enable Camera Roll Access"
            primary
            full
            {...{ onPress }}
          />
